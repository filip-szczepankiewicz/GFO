...
|-----------|---------|------|
| `Lmax`    | 8       | Maximum spherical harmonic band; higher = more precise spectral control |
| `s`       | 8       | Sobolev smoothness exponent; larger = faster high-frequency decay |
| `kappa`   | 7       | Sobolev scale parameter; larger = more weight on higher bands |
